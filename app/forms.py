...
def check_for_len(value):
    if len(value)<5:
        raise forms.ValidationError('len is very small')

class NameForm(forms.Form):
    name=forms.CharField(max_length=100,validators=[validate_for_a])
    ...
    def clean(self):
        ...
        if e!=r:
            raise forms.ValidationError('Not Matched')['botcatcher']
